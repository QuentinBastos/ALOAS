...
/* base.html.twig */
class __TwigTemplate_6917ba4e9d4ffc349706a7d5394386ea extends Template
{
...
";
    ...
    public function block_canonical(array $context, array $blocks = []): iterable
    {
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 13, $this->source); })()), "request", [], "any", false, false, false, 13), "uri", [], "any", false, false, false, 13), "html", null, true);
    ...
    {
        return array (  315 => 27,  301 => 22,  288 => 21,  274 => 18,  261 => 17,  238 => 13,  215 => 11,  192 => 10,  169 => 9,  146 => 8,  123 => 7,  110 => 28,  108 => 27,  103 => 24,  101 => 21,  98 => 20,  96 => 17,  90 => 14,  86 => 13,  81 => 11,  77 => 10,  73 => 9,  69 => 8,  65 => 7,  57 => 1,);
    }
...
<head>
    ...
    <title>{% block title %}ALOAS{% endblock %}</title>
    ...
    <link rel=\"shortcut icon\" type=\"image/x-icon\" href=\"{{ asset('build/images/aloas-logo.png') }}\">
    <link rel=\"icon\"
          href=\"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 128 128%22><text y=%221.2em%22 font-size=%2296%22>⚫️</text><text y=%221.3em%22 x=%220.2em%22 font-size=%2276%22 fill=%22%23fff%22>sf</text></svg>\">
    {% block stylesheets %}
...
", "base.html.twig", "/home/ubuntu/Projects/gestion-tournoi-aloas/templates/base.html.twig");
    }
}
