...
final class Version20250211103111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team CHANGE team_match_result_id tournament_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team CHANGE tournament_id team_match_result_id INT DEFAULT NULL');
