...
/**
 * Récupère les 20 derniers tournois créés
 */
...
<?php
    ...
    <?php
    /**
     * Récupère les équipes qualifiées pour les phases finales
     */
        unset($idGagnant);
        ...
        if(!isset($qualif[0]) || !isset($qualif[1])){}else{
            /**
             * Récupère les gagnants des matchs de qualification
             */
            if($sport == "p"){
    ...
    <div class="arbre_en_cours">
        ...
        <?php 
         /**
          * Récupère les gagnants des matchs de demi-finales
          */
            if($nbEquSelec >= 4){
        ...
        <div <?php if($nbEquSelec >= 8){echo "class=\"icones_etage4\"";}elseif($nbEquSelec >= 4){echo "class=\"icones_etage4\"";}else{echo "class=\"icones_etage4_2eq\"";}?>>
            ...
            <?php
            /**
             * Affiche l'équipe gagnante de la finale
             */
...
echo "YA UNE ERREUR";
        ...
        if($_SESSION['connecté'] == true){
            echo "<a class=\"bouton_voir_tournoi\" href=\"vue_tournoi_admin?idTournoi=".$tournoi->getId()."\">Gérer le tournoi</a>";
        }else {
            echo "<a class=\"bouton_voir_tournoi\" href=\"vue_tournoi?idTournoi=".$tournoi->getId()."\">Voir le tournoi</a>";
        }
